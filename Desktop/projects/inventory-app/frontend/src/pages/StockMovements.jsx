...
import { Plus, X, ArrowUp, ArrowDown, ArrowLeftRight } from 'lucide-react'
                ...
                {movements.length === 0
                  ...
                  : movements.map(m => (
                    <tr key={m._id}>
                      ...
                      <td style={{ fontSize:13 }}>{m.user?.name || '—'}</td>
                      <td style={{ color:'var(--text-muted)', fontSize:13, maxWidth:200 }}>{m.note || '—'}</td>
